        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    $query = "SELECT username, email, contacto, date_creation, Perfis_idPerfis, active FROM utilizadores
                    ...
                    mysqli_stmt_bind_result($stmt, $username, $email, $contacto, $data_criacao, $perfil, $active); // Bind results
                                ...
                                <form role="form" method="post" action="../scripts/sc_users_update.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="id_roles">
                                            ...
                                            $query2 = "SELECT idPerfis, perfil FROM perfis"; // Define the query;

                                            if (mysqli_stmt_prepare($stmt2, $query2)) { // Prepare the statement

                                                mysqli_stmt_execute($stmt2); // Execute the prepared statement

                                                mysqli_stmt_bind_result($stmt2, $id_perfil, $perfil_nome); // Bind results
                                                ...
                                                while (mysqli_stmt_fetch($stmt2)) {// Fetch values
                                                    ...
                                                    echo '<option value="' . $id_perfil . '" ' . $selected . '>' . $perfil_nome . '</option>';
                                                };
