...
<form method="post" action="upload_fotoestab.php" enctype="multipart/form-data">
    ...
    <div class="login_container" id="uploadpessoal">
        ...
        ?>
        <label class="label_login" style="margin-bottom: 20px"><b>Escolha uma Foto para o seu Estabelecimento:</b></label><br>
