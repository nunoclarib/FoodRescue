...
<div class="div_btns_forn_vol" align="center">
    ...
    <div class="div_btn_voluntario">
        <img class="img_forn_vol img_vol" src="img/voluntario.png">
        <a href="login_volun.php">
            <button class="btn_forn_vol btn_voluntario" type="button" name="btn_voluntario" value="perfil_voluntario">
                Voluntário
            </button>
        </a>
    </div>
