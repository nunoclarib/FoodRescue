    ...
    if (in_array($fileActualExt, $allowed)){
        ...
        if ($fileError===0){
            ...
            if ($fileSize < 13000000){
                ...
                header("Location: pages/perfil_edit.php?msg=0");
            }
        }
        else{
            echo 'Erro ao fazer upload';
            header("Location: pages/perfil_edit.php?msg=1");
        }
    }
    else{
        echo 'Não é suportado este tipo de ficheiro';
       header("Location: pages/perfil_edit.php?msg=2");
    }

}
else{
    echo'Não existe file';
   header("Location: pages/perfil_edit.php?msg=3");
}
