    ...
    if (in_array($fileActualExt, $allowed)) {
        ...
        if ($fileError === 0) {
            ...
            if ($fileSize < 13000000) {
                ...
                header("Location: editarperfil.php?msg=0");
            }
        } else {
            echo 'Erro ao fazer upload';
            header("Location: editarperfil.php?msg=1");
        }
    } else {
        echo 'Não é suportado este tipo de ficheiro';
        header("Location: editarperfil.php?msg=2");
    }

} else {
    echo 'Não existe file';
    header("Location: editarperfil.php?msg=3");
}
